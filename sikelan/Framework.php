...
class Framework
{
    ...
    protected ?EloquentManager $eloquentManager = null;
     ...
     * 初始化 Eloquent ORM
     *
     * PdoPool 由容器自动装配（依赖 Config），
     * EloquentManager 依赖 PdoPool + Config，同样自动装配。
     * 启动 Eloquent 后，App\Models\Model 的静态方法即可直接使用。
     */
    protected function initEloquent(): void
    {
        $this->eloquentManager = $this->container->get(EloquentManager::class);
        $this->eloquentManager->boot();
    }
     ...
     */
    public function getEloquent(): EloquentManager
    {
